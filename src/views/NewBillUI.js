            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <!--Erreur affichée lors du chargement d'un fichier au mauvais format-->
                    <p id = "file_error" class="valide" data-testid="erreur-file" >Erreur! Seul les formats jpg/jpeg/png sont acceptés</p>
                    </div>
                </div>
            </div>
            <div class="row">
